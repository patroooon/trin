...
namespace TrafficInfinity
{
    public class LeaderBoardUnity : MonoBehaviour
    {
        ...
        /*private async void Awake()
        {
            await UnityServices.InitializeAsync();
            await AuthenticationService.Instance.SignInAnonymouslyAsync();
            var scoresResponse = await LeaderboardsService.Instance.GetScoresAsync("leaderboard_config");
            await LeaderboardsService.Instance.AddPlayerScoreAsync(leaderboard_config, Score,);
